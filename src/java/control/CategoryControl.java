...
public class CategoryControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //b0:get parameter(after ? is cid => getParameter("cid"))
        ...
        DAO dao = new DAO();
             int totalMovies = dao.getPageMovieCountByCate(cateId);
             int endpage = totalMovies/6;
             if(endpage % 6 != 0){
                 endpage++;
             }
        List<Movies> list = dao.pagingMoviesesByCate(index,cateId);
